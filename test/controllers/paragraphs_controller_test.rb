...
class ParagraphsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paragraph" do
    assert_difference('Paragraph.count') do
      post paragraphs_url, params: { paragraph: { content: @paragraph.content, order: @paragraph.order, paragraph_id: @paragraph.paragraph_id, section_id: @paragraph.section_id } }
    end
  ...
  test "should update paragraph" do
    patch paragraph_url(@paragraph), params: { paragraph: { content: @paragraph.content, order: @paragraph.order, paragraph_id: @paragraph.paragraph_id, section_id: @paragraph.section_id } }
